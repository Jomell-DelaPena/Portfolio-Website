  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-wrap lg:flex-col gap-2 lg:items-stretch lg:min-w-36 lg:ml-auto">
          <a
            href={personal.calendarUrl}
            className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 hover:-translate-y-0.5"
            style={{
